      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className={cn(
              'relative flex max-h-[92vh] w-full flex-col overflow-hidden rounded-t-2xl border border-line bg-surface shadow-panel sm:rounded-2xl',
              widths[size],
            )}
          >
            ...
            {footer && (
              <div className="flex flex-wrap items-center justify-end gap-3 border-t border-line bg-canvas-soft/80 px-5 py-4 sm:px-6">
                {footer}
              </div>
            )}
          </motion.div>
      ...
      footer={
        <>
          <button
            type="button"
            onClick={onClose}
            className="inline-flex h-9 items-center rounded-xl border border-line bg-surface px-4 text-sm font-semibold text-muted transition-colors hover:bg-surface-2 hover:text-ink"
          >
            Cancel
          </button>
          <button
