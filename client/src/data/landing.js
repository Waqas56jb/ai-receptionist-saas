    ...
    columns: [
      {
        title: 'Software',
        items: [
          { href: '#how-it-works', icon: Sparkles, title: 'How it works', hint: 'Go live the same day', color: '#0066FF', bg: 'rgba(0,102,255,.12)' },
          { href: '#knowledge', icon: Database, title: 'Knowledge base', hint: 'Train it on your business', color: '#60a5fa', bg: 'rgba(96,165,250,.14)' },
          { href: '#product', icon: Mic, title: 'Voice agent', hint: 'Answer calls in a natural voice', color: '#FF7A00', bg: 'rgba(255,122,0,.14)' },
          { href: '#solutions', icon: MessageSquare, title: 'Messaging', hint: 'WhatsApp, web and social', color: '#FF9A33', bg: 'rgba(255,154,51,.14)' },
          { href: '#preview', icon: Radio, title: 'Live inbox', hint: 'Every conversation in one place', color: '#FF7A00', bg: 'rgba(255,122,0,.14)' },
        ],
      },
      {
        title: 'Channels',
        items: [
          { href: '#solutions', icon: PhoneCall, title: 'Phone', hint: 'Never miss another call', color: '#0066FF', bg: 'rgba(0,102,255,.12)' },
          { href: '#solutions', icon: MessageSquare, title: 'WhatsApp', hint: 'Instant replies on chat', color: '#60a5fa', bg: 'rgba(96,165,250,.14)' },
          { href: '#solutions', icon: Instagram, title: 'Instagram', hint: 'Handle DMs as they arrive', color: '#FF7A00', bg: 'rgba(255,122,0,.14)' },
          { href: '#solutions', icon: Globe, title: 'Web chat', hint: 'Catch visitors before they leave', color: '#FF9A33', bg: 'rgba(255,154,51,.14)' },
        ],
      },
    ],
    featured: {
    ...
    columns: [
      {
        ...
        items: [
          { href: '#industries', icon: Landmark, title: 'Bank', hint: 'Djibouti National Bank', color: '#0066FF', bg: 'rgba(0,102,255,.12)' },
          ...
          { href: '#industries', icon: Shield, title: 'Insurance Company', hint: 'Horn Africa Insurance', color: '#FF7A00', bg: 'rgba(255,122,0,.14)' },
          { href: '#industries', icon: Hospital, title: 'Hospital', hint: 'City General Hospital', color: '#FF9A33', bg: 'rgba(255,154,51,.14)' },
          { href: '#industries', icon: Stethoscope, title: 'Medical Clinic', hint: 'Al-Rahma Medical Clinic', color: '#0066FF', bg: 'rgba(0,102,255,.12)' },
          { href: '#industries', icon: Pill, title: 'Pharmacy', hint: 'Central Care Pharmacy', color: '#60a5fa', bg: 'rgba(96,165,250,.14)' },
          { href: '#industries', icon: GraduationCap, title: 'University', hint: 'International Business University', color: '#FF7A00', bg: 'rgba(255,122,0,.14)' },
          { href: '#industries', icon: BookOpen, title: 'Training Center', hint: 'Professional Skills Academy', color: '#FF9A33', bg: 'rgba(255,154,51,.14)' },
          { href: '#industries', icon: Building, title: 'Government Institution', hint: 'National Business Registration Office', color: '#0066FF', bg: 'rgba(0,102,255,.12)' },
      ...
      },
      {
        ...
        items: [
          { href: '#industries', icon: UtensilsCrossed, title: 'Restaurant', hint: 'Sultan Restaurant', color: '#0066FF', bg: 'rgba(0,102,255,.12)' },
          { href: '#industries', icon: Coffee, title: 'Café', hint: 'Blue Ocean Café', color: '#60a5fa', bg: 'rgba(96,165,250,.14)' },
          { href: '#industries', icon: Building2, title: 'Hotel', hint: 'Djibouti Palace Hotel', color: '#FF7A00', bg: 'rgba(255,122,0,.14)' },
          { href: '#industries', icon: ShoppingCart, title: 'Supermarket', hint: 'City Market Supermarket', color: '#FF9A33', bg: 'rgba(255,154,51,.14)' },
          { href: '#industries', icon: Smartphone, title: 'Telecommunications', hint: 'East Africa Telecom', color: '#0066FF', bg: 'rgba(0,102,255,.12)' },
          { href: '#industries', icon: Monitor, title: 'IT Company', hint: 'Digital Solutions Africa', color: '#60a5fa', bg: 'rgba(96,165,250,.14)' },
          { href: '#industries', icon: Truck, title: 'Logistics Company', hint: 'Horn Logistics & Transport', color: '#FF7A00', bg: 'rgba(255,122,0,.14)' },
          { href: '#industries', icon: Plane, title: 'Travel Agency', hint: 'Global Travel & Tours', color: '#FF9A33', bg: 'rgba(255,154,51,.14)' },
          { href: '#industries', icon: HardHat, title: 'Construction Company', hint: 'Modern Construction Group', color: '#0066FF', bg: 'rgba(0,102,255,.12)' },
    ...
    columns: [
      {
        title: 'Learn',
        items: [
          { href: '#how-it-works', icon: BookOpen, title: 'Setup guide', hint: 'Live the same day you sign up', color: '#0066FF', bg: 'rgba(0,102,255,.12)' },
      ...
      },
      {
        title: 'Company',
        items: [
          { href: 'mailto:hello@example.com', icon: Mail, title: 'Contact us', hint: 'A human answers every message', color: '#0066FF', bg: 'rgba(0,102,255,.12)' },
...
export const heroStats = [
  { value: '24/7', suffix: '', label: 'Always on', color: '#0066FF', bg: 'rgba(0,102,255,.12)' },
  { value: 'Instant', suffix: '', label: 'Reply speed', color: '#60a5fa', bg: 'rgba(96,165,250,.14)' },
  { value: 'No', suffix: '', label: 'New hardware', color: '#FF7A00', bg: 'rgba(255,122,0,.14)' },
]
