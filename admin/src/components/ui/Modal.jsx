      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className={cn('relative flex max-h-[92vh] w-full flex-col overflow-hidden rounded-t-2xl bg-white shadow-panel sm:rounded-2xl', widths[size])}
          >
            ...
            {footer && (
              <div className="flex flex-wrap items-center justify-end gap-3 border-t border-slate-200/80 bg-slate-50/60 px-5 py-4">{footer}</div>
            )}
          </motion.div>
        </motion.div>
      )}
